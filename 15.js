...
Obs.: Salário Bruto - Descontos = Salário Líquido.
             ...
             let salarioPorHora = parseFloat(prompt("Digite quanto você ganha por hora: "));
...
let descontosIR= salarioBruto * 11/100;   
let descontoINSS= salarioBruto * 8/100;
let sindicato= salarioBruto * 5/100;

let descontos = descontosIR- descontoINSS -sindicato

let salarioLiquido= salarioBruto - descontos;

console.log(" O seu salario é: R$" + salarioLiquido);
